...
import { useRouter } from 'next/router' // In package.json, so I wanted to use this, honestly this was a mistake. I should have used react-router-dom. I am not a fan of next/router.
                    ...
                    <ul>
                      {todos.map((todo) => (
                        <li
                          ...
                          className='todo-item'
                        >
                          {/* Found this design from a quick google search */}
                          <input
